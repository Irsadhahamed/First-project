...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBTpOo3Ce6gVn8yafZivM8kKWqbcl3r6rA"
...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://irsadh:Irsadh@guvi.1yp0dxh.mongodb.net/?retryWrites=true&w=majority&appName=guvi")
...
st.header(":black[YOUTUBE DATA HARVESTING AND WAREHOUSING]",divider='rainbow')
...
if question=="1.All the Videos and the Channel name":
    ...
    query10='''select title as videotitle, channel_name as channalname,comments as comments
            from videos where comments is not null order by comments desc'''
    cursor.execute(query10)
    mydb.commit()
    t10=cursor.fetchall()
    df9=pd.DataFrame(t10,columns=["videotitle","channel_name","comments"])
    st.write(df9)
